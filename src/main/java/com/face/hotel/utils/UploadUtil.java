...
import com.face.hotel.annotation.FaceRecognition;
...
public class UploadUtil {
    public final static String FACE_PATH = "src/main/resources/user_info/faces";

    public static void uploadFaceInfo(MultipartFile face) throws Exception {
